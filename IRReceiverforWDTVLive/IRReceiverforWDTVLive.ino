...
void loop(void)
{
  if (sended == 1)
  {
    ...
    {
      TrinketHidCombo.pressKey(0, KEYCODE_C); //Key code C is used for kodi maping (key C bring up the context menu but on my machine it fails using MMKEY_KB_MENU)
      TrinketHidCombo.pressKey(0, 0);
